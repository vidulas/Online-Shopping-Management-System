...
<header>
    ...
    <div class="containers">
        <div class="profile_box">
            <h1>User Profile</h1>
            <img src = "12.jpg" class = "profile-pic">

            
            <h3><?php echo $user_data['F_Name'];?></h3>
            <p><?php echo $user_data['Email'];?> </p>

            <a href="update.php ?id=<?php echo $user_data['F_Name']; ?>"><i class='bx bxs-message-square-edit' id = "dnbjdnj"></i></a>
            <a href="delete.php ?id=<?php echo $user_data['F_Name']; ?>"><i class='bx bxs-message-square-x' id = "dnbjnjl"></i></a>
